...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        /// </summary>
        private readonly Brush trackedJointBrush = Brushes.Yellow;
        ...
        private readonly Brush invalidSquatJointBrush = Brushes.Red;

        private readonly Brush validSquatJointBrush = Brushes.SpringGreen;
        ...
        private void DrawBody(IReadOnlyDictionary<JointType, Joint> joints, IDictionary<JointType, Point> jointPoints, DrawingContext drawingContext, Pen drawingPen)
        {
            ...
            foreach (JointType jointType in joints.Keys)
            {
                ...
                if (TrackingState.Tracked == trackingState && isSquatJoint(jointType) && validSquatJoint)
                {
                    drawBrush = this.validSquatJointBrush;
                    radius += 5;
                }
                else if(!validSquatJoint && isSquatJoint(jointType))
                {
                    drawBrush = this.invalidSquatJointBrush;
                }
        ...
        {
            return (jointType == JointType.HipLeft ||
